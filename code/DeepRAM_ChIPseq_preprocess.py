'''
This file is a copy of preprocess_1.py from deepRAM (https://github.com/MedChaabane/deepRAM).
It is used to generate negative sample of ChIP-seq_83's training set in the way similar to deepRAM.
'''
